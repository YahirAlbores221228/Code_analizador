...
_lr_productions = [
  ...
  ('program -> statement_list','program',1,'p_program','app3.py',118),
  ('statement_list -> statement','statement_list',1,'p_statement_list','app3.py',122),
  ('statement_list -> statement_list statement','statement_list',2,'p_statement_list','app3.py',123),
  ('statement -> declaration','statement',1,'p_statement','app3.py',127),
  ('statement -> assignment','statement',1,'p_statement','app3.py',128),
  ('statement -> if_statement','statement',1,'p_statement','app3.py',129),
  ('statement -> while_statement','statement',1,'p_statement','app3.py',130),
  ('statement -> do_while_statement','statement',1,'p_statement','app3.py',131),
  ('statement -> for_statement','statement',1,'p_statement','app3.py',132),
  ('statement -> input_statement','statement',1,'p_statement','app3.py',133),
  ('statement -> block','statement',1,'p_statement','app3.py',134),
  ('declaration -> INT ID EQUALS NUMBER SEMICOLON','declaration',5,'p_declaration','app3.py',138),
  ('declaration -> FLOAT ID EQUALS FLOAT_NUMBER SEMICOLON','declaration',5,'p_declaration','app3.py',139),
  ('declaration -> STRING ID EQUALS STRING_LITERAL SEMICOLON','declaration',5,'p_declaration','app3.py',140),
  ('declaration -> INT ID EQUALS FLOAT_NUMBER SEMICOLON','declaration',5,'p_declaration_error_int','app3.py',159),
  ('declaration -> INT ID EQUALS STRING_LITERAL SEMICOLON','declaration',5,'p_declaration_error_int','app3.py',160),
  ('declaration -> FLOAT ID EQUALS NUMBER SEMICOLON','declaration',5,'p_declaration_error_float','app3.py',164),
  ('declaration -> FLOAT ID EQUALS STRING_LITERAL SEMICOLON','declaration',5,'p_declaration_error_float','app3.py',165),
  ('declaration -> STRING ID EQUALS NUMBER SEMICOLON','declaration',5,'p_declaration_error_string','app3.py',169),
  ('declaration -> STRING ID EQUALS FLOAT_NUMBER SEMICOLON','declaration',5,'p_declaration_error_string','app3.py',170),
  ('assignment -> ID EQUALS expression SEMICOLON','assignment',4,'p_assignment','app3.py',174),
  ('assignment -> ID PLUSPLUS SEMICOLON','assignment',3,'p_assignment','app3.py',175),
  ('expression -> NUMBER','expression',1,'p_expression','app3.py',187),
  ('expression -> FLOAT_NUMBER','expression',1,'p_expression','app3.py',188),
  ('expression -> STRING_LITERAL','expression',1,'p_expression','app3.py',189),
  ('expression -> ID','expression',1,'p_expression','app3.py',190),
  ('expression -> expression MULTIPLY expression','expression',3,'p_expression','app3.py',191),
  ('expression -> expression PLUS expression','expression',3,'p_expression','app3.py',192),
  ('input_statement -> INPUT LPAREN expression RPAREN SEMICOLON','input_statement',5,'p_input_statement','app3.py',215),
  ('if_statement -> IF LPAREN condition RPAREN block','if_statement',5,'p_if_statement','app3.py',220),
  ('while_statement -> WHILE LPAREN condition RPAREN block','while_statement',5,'p_while_statement','app3.py',224),
  ('do_while_statement -> DO statement_list ENDDO WHILE LPAREN condition RPAREN ENDWHILE','do_while_statement',8,'p_do_while_statement','app3.py',228),
  ('for_statement -> FOR LPAREN ID IN RANGE LPAREN NUMBER COMMA NUMBER RPAREN RPAREN block','for_statement',12,'p_for_statement','app3.py',232),
  ('condition -> expression EQ expression','condition',3,'p_condition','app3.py',236),
  ('condition -> expression NE expression','condition',3,'p_condition','app3.py',237),
  ('condition -> expression GT expression','condition',3,'p_condition','app3.py',238),
  ('condition -> expression LT expression','condition',3,'p_condition','app3.py',239),
  ('condition -> expression GE expression','condition',3,'p_condition','app3.py',240),
  ('condition -> expression LE expression','condition',3,'p_condition','app3.py',241),
  ('condition -> condition AND condition','condition',3,'p_condition','app3.py',242),
  ('block -> LBRACE statement_list RBRACE','block',3,'p_block','app3.py',246),
]
